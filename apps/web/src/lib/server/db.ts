...
import ws from 'ws';
import { POSTGRES_POOLS_CONNECTION_STRING } from '$env/static/private';
 ...
 */
export const pool = new Pool({ connectionString: POSTGRES_POOLS_CONNECTION_STRING });
export const http = neon(POSTGRES_POOLS_CONNECTION_STRING as string);
